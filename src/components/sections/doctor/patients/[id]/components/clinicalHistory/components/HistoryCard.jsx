        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div className="bg-beehealth-body-main rounded-xl p-3 shadow-sm transition hover:shadow-md sm:p-4">
              <p className="text-beehealth-green-primary-solid flex items-center gap-2 text-sm font-semibold">
                <Stethoscope className="text-beehealth-green-primary-solid h-4 w-4" />
                Notas del médico
              </p>
