      ...
      case 'date':
        return (
          <input
            ...
            className="bg-beehealth-body-main w-full rounded-lg border-2 border-gray-200 px-3 py-2 text-sm transition focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
          />
        );
