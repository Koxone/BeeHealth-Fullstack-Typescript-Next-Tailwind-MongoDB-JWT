  ...
  return (
    <div className="mt-6 flex flex-wrap items-center gap-4 border-t-2 border-gray-200 pt-4 text-xs">
      <div className="flex items-center gap-2">
        <div className="h-5 w-5 rounded-lg border-2 border-blue-300 bg-linear-to-br from-blue-50 to-indigo-50" />
      ...
      <div className="flex items-center gap-2">
        <div className="h-5 w-5 rounded-lg bg-linear-to-br from-blue-600 to-indigo-600 shadow-sm" />
