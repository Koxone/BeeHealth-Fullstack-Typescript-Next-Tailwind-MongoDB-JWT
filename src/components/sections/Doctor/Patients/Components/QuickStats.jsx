...
export default function QuickStats({ stats, icons }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
      <div className="group rounded-2xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-100 p-6 shadow-lg transition hover:scale-105">
      ...
      <div className="group rounded-2xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-100 p-6 shadow-lg transition hover:scale-105">
        <div className="mb-3 flex items-center justify-between">
      ...
      <div className="group rounded-2xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-100 p-6 shadow-lg transition hover:scale-105">
        <div className="mb-3 flex items-center justify-between">
